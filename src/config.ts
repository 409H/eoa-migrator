const CONFIG = {
    ...
    CHAINS: [{
        ...
        default_api_key: process.env.REACT_APP_ETHERSCAN_API_KEY,
        ...
        default_api_key: process.env.REACT_APP_BSCSCAN_API_KEY,
        ...
        default_api_key: process.env.REACT_APP_POLYGONSCAN_API_KEY,
